...
--
-- Host: localhost:3306
-- Generation Time: Jun 24, 2023 at 08:33 PM
...
CREATE TABLE `exercises` (
  ...
  `file` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT 'Un lien vers un fichier vidéo ou image qui décrit l''exercice'
...
CREATE TABLE `users` (
  ...
  `login` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'Pseudo de l''utilisateur',
