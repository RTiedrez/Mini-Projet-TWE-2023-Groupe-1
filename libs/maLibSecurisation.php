...
function verifUser($login,$password)
{
	if ($idUser = verifUserBdd($login, $password)) {
		...
		$_SESSION["connecte"] = true; // La magie des cookies
 ...
 * Cette fonction redirige vers la page $urlBad en envoyant un message d'erreur et arrête l'interprétation si l'utilisateur n'est pas connecté
